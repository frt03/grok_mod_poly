...
class Exp(object):
    def __init__(self) -> None:
        ...
        self.fns_dict = {
            ...
            '_x_y__3': lambda x, y: (x + y)**3  % self.p,
            '_x_y__4': lambda x, y: (x + y)**4  % self.p,
            ...
            '_x_m_y__3': lambda x, y: (x - y)**3  % self.p,
            '_x_m_y__4': lambda x, y: (x - y)**4  % self.p,
