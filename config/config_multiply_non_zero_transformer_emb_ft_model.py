...
class Exp(object):
    def __init__(self) -> None:
        ...
        self.load_weigths = ['transformer']  # ['full', 'embed', 'transformer', 'unembed']
        load_weigths = '_'.join(self.load_weigths)
        self.frozen_weigths = ['transformer']  # ['full', 'embed', 'transformer', 'unembed']
        ...
        # dataset
        self.fn_name = 'multiply_non_zero'
        self.frac_train = 0.3
        ...
        # save directory
        self.root = Path(f"log/{self.model}_{self.fn_name}_emb_ft_231202")
